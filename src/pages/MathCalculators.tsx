  ...
  const calculatorCategories = [
    ...
    },
    {
      ...
      calculators: [
        ...
        { name: 'System of Equations', path: '/system-equations', description: 'Solve systems of linear equations', icon: Function },
    ...
    },
    {
      ...
      calculators: [
        ...
        { name: 'Standard Deviation Calculator', path: '/standard-deviation', description: 'Calculate population and sample standard deviation', icon: BarChart3 },
